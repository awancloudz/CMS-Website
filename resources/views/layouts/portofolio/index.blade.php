                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-topline-aqua">
                                <div class="card-head">
                                    <header>DAFTAR PORTOFOLIO</header>
                                </div>
                                <div class="card-body ">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <button id="addRow1" class="btn btn-info">
                                                    Portofolio Baru <i class="fa fa-plus"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    <table class="table table-striped table-hover table-checkable order-column" style="width: 100%" id="example4">
                                        ...
                                        @if(count($data) > 0)
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td><img src="{{ asset('klien/'.$porto->picture)}}" width="100" heigth="100"></td>
                                                <td> {{ $porto->title }} </td>
                                                <td>{{ $porto->link }}</td>
                                                <td>
                                                    @if($porto->active == 'Y')
